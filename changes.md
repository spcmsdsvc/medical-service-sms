...
- Added the approver-facing Calibration Report link to the 2026-09-02 release manifest and recorded the isolated execution plan in `plans.md`. The implementation remains confined to the clean feature worktree until final verification and publication.
