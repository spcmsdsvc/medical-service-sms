...
- Added the approver-facing Calibration Report link to the 2026-09-02 release manifest and recorded the isolated execution plan in `plans.md`. The feature implementation is committed as `c52d742` in the clean feature worktree; publication is being performed only after the remote-head recheck.
