...
class AnalyticsPageTests(unittest.TestCase):
    ...
    def test_page_is_tokenized_accessible_and_separates_p_o_only_view(self):
        ...
        self.assertIn('analytics-tabs', self.template)
        self.assertIn('data-analytics-tab', self.template)
        ...
        self.assertIn('.analytics-tab-panel { display: none;', self.css)
        self.assertIn('.analytics-tab-panel { display: block !important;', self.css)
